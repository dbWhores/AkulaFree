while True:
    try:
       ...
       ▀███████████ ███   ███ ███    ███ ▀▀███▀▀▀██▄  ███▌ ▀███████████  
         ...
         ███    █▀   ▀█   █▀  ████████▀  ▄█████████▀  █▀    ▄████████▀
                ...
                Welcome to Anubis, Press "ENTER" to continue! Крякнул  Asoru мой ккнал: @perehodasoru Anubis идёт нахуй теперь проект мой'''), pystyle.Colors.white_to_red, pystyle.Colorate.Vertical, enter=True)
        def Main():
            if platform.system() == "Windows":
                os.system("cls")
 ...
 [3] Поиск по нику          [14] Генератор всего
...
Отправили письмо - следуйте этим же шагам в правильной последовательности. Выйдите из Tor, Linux, а затем из VPN.\n''', pystyle.Colors.white_to_red, interval = 0.005)
            if choice == '19':
                ...
                if mode == "1":
                    ...
                    print()
            if choice == "14":
                os.system("python AkulaFGener.py")
        ...
        "Mozilla/5.0 (X11; Linux x86_64; rv:{0}.0) Gecko/{0}{1:02d} Firefox/{0}.0",
                ...
                print()
            if choice == "21":
                pystyle.Write.Print("\n[+] Ебучая паста спизженная у анубиса, п.с я спиздила сурс у анубиса, теперь это не анубис а акула фри. тгк @AkulaTools\n", pystyle.Colors.white_to_red, interval = 0.005)
            if choice == "22":
                pystyle.Write.Print("\n[+] Ебучая паста спизженная у анубиса, п.с я спиздила сурс у анубиса, теперь это не анубис а акула фри. тгк @AkulaTools\n", pystyle.Colors.white_to_red, interval = 0.005)
            if choice == "23":
